...
val md_theme_light_primary = Color(0xFFFFD700)
...
val md_theme_light_secondaryContainer = Color(0xFFFFED8A)
...
val md_theme_dark_primary = Color(0xFFFFD700)
...
val md_theme_dark_secondaryContainer = Color(0xFFFFED8A)
